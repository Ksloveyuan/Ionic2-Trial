...
export class ConferenceApp {
  ...
  appPages: PageInterface[] = [
    { title: 'Schedule', name: 'TabsPage', component: TabsPage, tabComponent: PatientSchedulePage, index: 0, icon: 'calendar' },
    { title: 'Event Stream', name: 'TabsPage', component: TabsPage, tabComponent: ClinicianSchedulePage, index: 1, icon: 'list' },
  ];
